...
class BSTree                                     // KeyType : key field
{
  ...
  protected:
    ...
    void insertHelper(const DataType& newDataItem, BSTreeNode* r);
    bool retrieveHelper(const KeyType& searchKey, DataType& searchDataItem, BSTreeNode* r) const;
    ...
    void heightHelper(BSTreeNode* r, int level) const;
    int countHelper(BSTreeNode* r) const;
    void writeLessThanHelper(const KeyType& searchKey, BSTreeNode* r) const;
    // Data member
